...
public class BaseClass {
  ...
  //Method 1 (browser launch) 
	public static WebDriver browserLaunch(String browsername) {
		...
		try {
			if (browsername.equalsIgnoreCase("chrome")) {
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\THANVIKA\\eclipse-workspace\\Cucumber\\driver\\chromedriver.exe");
	...
	public static void drop(WebElement dropvalue) {
		...
		public static void select1(WebElement droptext,String value) {
